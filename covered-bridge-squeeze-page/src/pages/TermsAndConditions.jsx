        ...
        <div className="container legal-container">
          <div className="terms__inner-container">
            <header>
              ...
              <h1 className="legal__header gradient-text">
                Terms & Conditions
              </h1>
            ...
            <main className="legal-content">
              <section className="legal-section">
                ...
                <p>
                  ...
                  landowners. We are not real estate brokers. When you provide
                  us with property details, you agree that the offer we make is
              ...
              <section className="legal-section">
                ...
                <p>
                  There are no hidden fees, commissions, or upfront costs
                  involved when dealing with us. Our cash offers and
                  transactions are structured to be completely transparent—you
                  only receive the agreed cash offer without any deductions.
                </p>
              </section>
              ...
              <section className="legal-section">
                ...
                <p>
                  ...
                  based on property details, title status, excessive back taxes
                  or unforeseen issues without liability. Your engagement with
                  us does not obligate you to accept our offer.
                </p>
              </section>
              ...
              <section className="legal-section">
                ...
                <p>
                  ...
                  Properties LLC shall not be liable for any indirect,
                  incidental, or consequential damages arising out of or related
                  to your use of our services, even if advised of the
                  possibility of such damages. Our offers and transaction
                  details are provided “as-is” and without warranties of any
                  kind.
                </p>
              </section>
              ...
              <section className="legal-section">
                ...
                <p>
                  ...
                  United States and the state in which Covered Bridge Properties
                  LLC is headquartered. Any disputes arising will be resolved in
              ...
              <section className="legal-section">
                ...
                <p>
                  ...
                  changes will be posted on our website with a new “Last
                  Updated” date. Your continued engagement with our services
